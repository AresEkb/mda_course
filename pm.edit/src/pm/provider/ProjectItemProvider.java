...
/**
 * This is the item provider adapter for a {@link pm.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PmPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addClosedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_closed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_closed_feature", "_UI_Project_type"),
				 PmPackage.Literals.PROJECT__CLOSED,
				 true,
				 false,
				 false,
	...
	protected void addParticipantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_participants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_participants_feature", "_UI_Project_type"),
				 PmPackage.Literals.PROJECT__PARTICIPANTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addManagerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_manager_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_manager_feature", "_UI_Project_type"),
				 PmPackage.Literals.PROJECT__MANAGER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_tasks_feature", "_UI_Project_type"),
				 PmPackage.Literals.PROJECT__TASKS,
				 true,
				 false,
				 true,
				 null,
