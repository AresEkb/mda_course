...
public class EmployeeItemSemanticEditPolicy extends
	...
	public EmployeeItemSemanticEditPolicy() {
		super(PmElementTypes.Employee_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PmVisualIDRegistry.getVisualID(incomingLink) == ProjectManagerEditPart.VISUAL_ID) {
			...
			if (PmVisualIDRegistry.getVisualID(incomingLink) == ProjectParticipantsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
			...
			if (PmVisualIDRegistry.getVisualID(incomingLink) == TaskExecutorEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
