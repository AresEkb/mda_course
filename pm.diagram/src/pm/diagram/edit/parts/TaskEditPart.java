...
import pm.diagram.edit.policies.TaskItemSemanticEditPolicy;
...
public class TaskEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(PmElementTypes.TaskParent_4020);
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof pm.diagram.edit.parts.TaskEditPart) {
			types.add(PmElementTypes.TaskParent_4020);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == PmElementTypes.TaskExecutor_4019) {
			types.add(PmElementTypes.Employee_2004);
		} else if (relationshipType == PmElementTypes.TaskParent_4020) {
			types.add(PmElementTypes.Task_2006);
		} else if (relationshipType == PmElementTypes.TaskProject_4021) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == PmElementTypes.TaskParent_4020) {
			types.add(PmElementTypes.Task_2006);
		}
		return types;
	}
