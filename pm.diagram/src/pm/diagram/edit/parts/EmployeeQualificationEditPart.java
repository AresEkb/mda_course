 ...
 * @generated
 */
public class EmployeeQualificationEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public EmployeeQualificationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new PmTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new DocumentRootEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PmParserProvider
					.getParser(
							PmElementTypes.Employee_2004,
							getParserElement(),
							PmVisualIDRegistry
									.getType(pm.diagram.edit.parts.EmployeeQualificationEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					PmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
