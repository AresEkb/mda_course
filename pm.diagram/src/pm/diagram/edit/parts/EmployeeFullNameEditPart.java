 ...
 * @generated
 */
public class EmployeeFullNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EmployeeFullNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = PmParserProvider
					.getParser(
							...
							getParserElement(),
							PmVisualIDRegistry
									.getType(pm.diagram.edit.parts.EmployeeFullNameEditPart.VISUAL_ID));
		}
		return parser;
	}
