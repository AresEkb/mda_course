...
public class ProjectCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Project newElement = PmFactory.eINSTANCE.createProject();

		DocumentRoot owner = (DocumentRoot) getElementToEdit();
		owner.getProjects().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Project newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
