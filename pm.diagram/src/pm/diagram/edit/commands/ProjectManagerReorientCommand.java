 ...
 * @generated
 */
public class ProjectManagerReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProjectManagerReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProjectManager_4017(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return PmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProjectManager_4017(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setManager(null);
		getNewSource().setManager(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setManager(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
