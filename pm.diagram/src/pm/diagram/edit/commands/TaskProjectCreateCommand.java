 ...
 * @generated
 */
public class TaskProjectCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TaskProjectCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return PmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateTaskProject_4021(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setProject(getTarget());
		}
